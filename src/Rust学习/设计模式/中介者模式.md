...
[代码示例](https://github.com/169LI/rust-study/tree/master/example_code/DesignPattern/mediator_pattern/src/main.rs)
...
- 异步或跨线程场景可用 **ch`annel** 做事件总线，实现解耦。
